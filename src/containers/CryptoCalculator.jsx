...
const CryptoCalculator = () => {
  ...
  return (
    <Container>
      ...
      <Row>
        <Input value={initialCost} tooltipMessage={APP_CONSTANTS.initialCost} onChange={(value) => handleChange(setInitialCost, 'initialCost')(value)} prefix="Initial Margin" postfix="$"/>
      </Row>
      <Row>
      ...
      <Row>
        <Input value={entryPrice} tooltipMessage={APP_CONSTANTS.entryPrice} onChange={(value) => handleChange(setEntryPrice, 'entryPrice')(value)} prefix="Entry Price"/>
      </Row>
      <Row>
        <Input value={tpMark} tooltipMessage={APP_CONSTANTS.TPMarkDesc} onChange={(value) => handleChange(setTPMark, 'tpMark')(value)} prefix="Take Profit Mark"/>
      </Row>
      <Row>
        <Input value={slMark} tooltipMessage={APP_CONSTANTS.SLMarkDesc} onChange={(value) => handleChange(setSLMark, 'slMark')(value)} prefix="Stop Loss Mark"/>
      </Row>
      <Row>
        <Input value={totalCapital} tooltipMessage={APP_CONSTANTS.totalCapitalDesc} onChange={(value) => handleChange(setTotalCapital, 'totalCapital')(value)} prefix="Total Capital" postfix="$"/>
      </Row>
      <Divider/>
      <Report
        isLong={isLong}
